...
async function deleteReview(id) {
  try {
    await apiDelete(`products/reviews/${id}`);
        ...
        <section v-if="activeTab === 'products'" class="card" style="margin-bottom:18px;">
         ...
         <div v-if="products" style="margin-top:20px; display:flex; justify-content:center; align-items:center;">
              <button
                ...
                style="padding:8px 14px; border-radius:6px; color: white; background: #1e90ff; border:1px solid #ccc; cursor:pointer; font-size:14px; margin-right:12px;"
              >
                Trước
              </button>
              ...
              <button
                ...
                @click="goToProductPage(products.meta.current_page + 1)"
                style="padding:8px 14px; border-radius:6px; color: white; background: #1e90ff; border:1px solid #ccc; cursor:pointer; font-size:14px; margin-left:12px;"
              >
                Sau
              </button>
            </div>
